<%@ Page Title="" Language="C#" MasterPageFile="~/Student_Panel/Student_Master.Master" AutoEventWireup="true" CodeBehind="StudentView_Results.aspx.cs" Inherits="School_Management_System.Student_Panel.StudentView_Results" %>
                ...
                <div class="row clearfix">
                    <div class="container" style="border: groove">
                        ...
                        <div class="form-group" style="text-align: center; width: 100%; height: 70px; padding: 5px; background-color: darkgray">
                            <div style="">
                                <h1 style="color: white;">View Exam Results</h1>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8" style="padding-bottom: 15px;">
                                <asp:Button ID="btnsubmit" CssClass="btn btn-success btn-lg" runat="server" Text="View Results" />&nbsp;&nbsp;&nbsp;
