<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewTimeTable.aspx.cs" Inherits="School_Management_System.Admin_Panel.ViewTimeTable" %>
        ...
        <div class="container" style="border: groove">
            ...
            <div class="row">
                ...
                <div class="col-md-6" style="padding-bottom: 15px;">
                    <asp:Button ID="btnsubmit" CssClass="btn btn-success" runat="server" Text="View Timetable" />&nbsp;&nbsp;&nbsp;
