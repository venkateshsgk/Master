<%@ Page Title="" Language="C#" MasterPageFile="~/Student_Panel/Student_Master.Master" AutoEventWireup="true" CodeBehind="StudentView_Timetable.aspx.cs" Inherits="School_Management_System.Student_Panel.StudentView_Timetable" %>
      ...
      <form id="form1" runat="server" class="forms-sample">
        ...
        <div class="main-content">
            ...
            <div class="form-group" style="text-align: center; width: 100%; height: 70px; padding: 5px; background-color: darkgray">
                <div style="">
                    <h1 style="color: white;">View Timetable</h1>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-8" style="padding-bottom: 15px;">
                    <asp:Button ID="btnsubmit" CssClass="btn btn-success btn-lg" runat="server" Text="View Timetable" />&nbsp;&nbsp;&nbsp;
