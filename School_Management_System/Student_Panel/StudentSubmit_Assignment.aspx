<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StudentSubmit_Assignment.aspx.cs" Inherits="School_Management_System.Student_Panel.StudentSubmit_Assignment" %>
    ...
    <form id="form1" runat="server" class="forms-sample">
        ...
        <div class="container" style="border: groove">
            ...
            <div class="form-group" style="text-align: center; width: 100%; height: 70px; padding: 5px; background-color: darkgray">
                <div style="">
                    <h1 style="color: white;">Submit Assignments</h1>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-7">
                 ...
                 <div class="col-md-3">
                    <label><h6>Select Assignment File *</h6> </label>
                    <div class="form-group">
                        <asp:FileUpload ID="fuAssignment" runat="server" />
                    </div>
                </div>
                <div class="col-md-8" style="padding-bottom: 15px;">
                    <asp:Button ID="btnsubmit" CssClass="btn btn-success btn-lg" runat="server" Text="Submit Assignments" />&nbsp;&nbsp;&nbsp;
