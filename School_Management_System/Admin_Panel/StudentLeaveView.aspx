<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StudentLeaveView.aspx.cs" Inherits="School_Management_System.Admin_Panel.StudentLeaveView" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="card" style="min-height: 200px;border:groove">
            <div class="form-group" style="text-align: center; width: 100%; height: 70px; padding: 5px; background-color: darkgray">
                <div style="">
                    <h1 style="color: white;">View Student Leaves</h1>
                </div>
            </div>
