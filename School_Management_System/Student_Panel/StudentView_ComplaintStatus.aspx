<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StudentView_ComplaintStatus.aspx.cs" Inherits="School_Management_System.Student_Panel.StudentView_ComplaintStatus" %>
     ...
     <form id="form1" runat="server" class="forms-sample">
        ...
        <div class="container" style="border: groove">
            ...
            <div class="form-group" style="text-align: center; width: 100%; height: 70px; padding: 5px; background-color: darkgray">
                <div style="">
                    <h1 style="color: white;">View Complaint Status</h1>
                </div>
            </div>
