<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Teacher_AddAssignments.aspx.cs" Inherits="School_Management_System.TeacherPanel.Teacher_AddAssignments" %>
            ...
            <div class="container-fluid">
                <div class="row clearfix">
                    <div class="container">
                          ...
                          <%--<h5>Exams & Assignments <span style="color:orangered;font:8px;"> > Add_Assingments</></span></h5>--%>
                    
                        <div class="row" >

                            <div class="form-group" style="background-color: darkgray; width: 100%; height: 80px; text-align: center; color: white; font-size: 20px;">
                                <h1>Add Assingments</h1>
                            </div>

                            <div class="col-md-4">
                                <label>
                                    <h6>Assingments Title</h6>
                                </label>
